...
#Espacializar pontos
occ_gbif <- vect(occ2, geom = c(x = "decimalLongitude", y = "decimalLatitude"),
                crs = "epsg:4326")
...
# Repita o procedimento acima com uma outra espécie de sua preferência
# Copie o código acima e cole aqui embaixo para repetir, ou use um novo script
